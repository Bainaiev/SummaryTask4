...
public class LocaleFilter extends BaseFilter {
    ...
    public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        String locale = request.getParameter(Attributes.LANG);
        if (locale == null) {
    ...
    private void loadLocales(FilterConfig filterConfig) {
        locales = filterConfig.getServletContext().getInitParameter(Attributes.LOCALES).split(" ");
    ...
    private void setLocale(HttpServletRequest request, HttpServletResponse response, String locale) {
        request.setAttribute(Attributes.CURRENT_LOCALE, locale);
