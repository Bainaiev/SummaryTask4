package ua.nure.bainaiev.SummaryTask4.db.manager;
...
public final class DatabaseConfig {
    ...
    static {
        try (InputStream resource = DatabaseConfig.class.getResourceAsStream(DATABASE_CONFIG_FILE)) {
            ...
            USE_UNICODE = properties.getProperty("useUnicode");
    ...
    private static String defineConnectionUrl() {
        return "jdbc:" + RDBMS + "://" + SERVER + ":" + PORT + "/"
                + DATABASE + "?characterEncoding=" + ENCODING + "&useUnicode=" + USE_UNICODE;
